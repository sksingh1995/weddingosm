            ...
            <div class="row">
                  <div class="col-lg-8">
                        <div class="box_cart">
                              ...
                              <div class="step">
                                    ...
                                    <p>
                                          Lorem ipsum dolor sit amet, vim id accusata sensibus, id ridens quaeque qui. Ne qui vocent ornatus molestie, reque fierent
                                          dissentiunt mel ea.
                                    </p>
                                    <p>
                              ...
                              <div id="policy">
                                    ...
                                    <p class="nomargin">Lorem ipsum dolor sit amet, vix <a href="#0">cu justo blandit deleniti</a>, discere omittantur
                                          consectetuer per eu. Percipit repudiare similique ad sed, vix ad decore nullam
                                          ornatus.
                                    </p>
                              </div>
                        </div>
                  ...
                  <aside class="col-lg-4" id="sidebar">
                        <div class="box_detail">
                              ...
                              <a href="{{route('checkout.thanks')}}" class="btn_1 full-width purchase">Purchase</a>
