<template>
    ...
    <div class="vendor-register-box">
     <figure style="text-align: center;">
      ...
      <div class="vendor-register-welcome-text">
       <h3>"Make your wedding osm with WeddingOSM"</h3>
 ...
 <form autocomplete="off" @submit.prevent="register" v-if="!registered" ref="form">
  ...
  <div class="form-group" v-bind:class="{'has-error':errors.has('gender')}">
    <label>Gender</label>
    <select class="form-control custom-select" name="gender"  v-validate="'required'">
      <option value="">Select your gender</option>
      <option value="male">Male</option>
      <option value="female">Female</option>
    </select>
    <span class="help-block"  v-show="errors.has('gender')">Please select your gender</span>
  </div>
</div>
...
<div class="are-you-box">
  <a href="/vendor/register">Are you a Vendor? 
